...
function show_data() {
  ...
  console.log('mind_data', mind_data);
  var mind_string = jsMind.util.json.json2string(mind_data);
  console.log('mind_string', mind_string);
...
function get_nodearray_data() {
  ...
  console.log('node_array data', mind_data);
  var mind_string = jsMind.util.json.json2string(mind_data);
  console.log('node_array string', mind_string);
  prompt_info(mind_string);
}
